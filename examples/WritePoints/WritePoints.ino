...
void setup()
{
    WiFi.setPins(8, 7, 4, 2); //Adafruit M0 WiFi
    Serial.begin(115200);
    ...
    // influx.authorize(INFLUX_AUTH);                //if you have set the Influxdb .conf variable auth-enabled to true, uncomment this
    // influx.useTLS(true);                          //uncomment if you have generated a CA cert and copied it into InfluxCert.hpp
